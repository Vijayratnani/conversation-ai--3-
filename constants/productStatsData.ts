// constants/productStatsData.ts
import { ProductStatItem } from "@/types/dashboardTypes" // Adjust based on where your type is
import { FileText, Package, BarChart3, Headphones } from "lucide-react" // Adjust icons as needed

export const productStats: ProductStatItem[] = [
    {
      id: "credit-cards",
      title: "Credit Cards",
      value: "42%",
  ...
  // ...Add the rest of the objects for 'personal-loans', 'savings-accounts', 'mortgages', 'investment-products'
